        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <button className='btn btn-link'>
                <Link className="nav-link" to={"/category/1"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-laptop" viewBox="0 0 16 16">
            ...
            <li className="nav-link">
                ...
                <Link className="nav-link" to={"/category/2"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-tv" viewBox="0 0 16 16">
            ...
            <li className="nav-link">
                ...
                <Link className="nav-link" to={"/category/3"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-phone" viewBox="0 0 16 16">
